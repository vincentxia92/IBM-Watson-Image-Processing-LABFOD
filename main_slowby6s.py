...
if __name__ == '__main__':
    ...
    while(True):
        try:
            ch = stream.show_frame() #cv2.imshow
            ...
            if loc is None:  # if none object detected when current interval starts, dirently move to next frame
                continue
